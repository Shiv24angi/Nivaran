...
interface MenuBarProps {
  ...
  onSelect?: (
    key: "dashboard" | "notifications" | "settings" | "help" | "security"
  ) => void;
}
...
const IconButton: React.FC<IconButtonProps> = ({ icon, label, active, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <span
        className={`text-sm transition-all duration-300 whitespace-nowrap pointer-events-none ml-2 hidden sm:inline ${
